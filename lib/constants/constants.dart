...
class Constants {
  ...
  // static const EdgeInsets APP_LOGO_PADDING = EdgeInsets.fromLTRB(40,0,40,0);
  static const EdgeInsets APP_LOGO_MARGIN = EdgeInsets.symmetric(horizontal: 40.0);
  static const Color APP_MAIN_BG_COLOR = Colors.teal;
  // static const Color APP_HEADER_BG_COLOR = Colors.blue;
